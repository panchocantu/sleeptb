...
- (void)viewDidLoad {
    ...
    countLabel.frame = CGRectMake(self.btnSleepAwake.frame.origin.x - 113,
                                  self.btnSleepAwake.frame.origin.y,
                                  self.btnSleepAwake.frame.size.width,
                                  self.btnSleepAwake.frame.size.height);
